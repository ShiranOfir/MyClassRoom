...
נוסף חיפוש בכל האפליקציה:
- תלמידים מופיעים ראשונים.
- החיפוש כולל שמות תלמידים, מעקבים והיסטוריה אישית.
- החיפוש כולל משימות של השבוע.
- החיפוש כולל משימות שהושלמו בארכיון השבועי.
- לחיצה על תלמיד/ה פותחת ישירות את ה-Popup האישי עם שדה חדש להוספת מעקב.
- אפשר מה-Popup לשמור ○ במעקב, ✓ בהיסטוריה או + לטודוליסט.
- לחיצה על משימה מקפיצה אליה ומדגישה אותה.
- קיצור מקלדת בדסקטופ: Ctrl+K / Cmd+K.

לא נעשה שינוי במבנה הנתונים של Firebase.
